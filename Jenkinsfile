pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/perezi3'                               //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-cit/225-lab3-9.git' //<-----change this to match this new repository!
        KUBECONFIG = credentials('perezi3-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
